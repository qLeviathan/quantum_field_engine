...
class QFNNFieldExpanderStableV1:
    def __init__(self, model_name="gpt2", max_tokens=5000):
        ...
        # Filter clean tokens: remove weird GPT artifacts (only alphanumeric tokens)
    ...
    def expand_field(self, prompt, num_new_tokens=10, steps_per_evolve=500, diversity_penalty=0.1):
        ...
        for _ in range(num_new_tokens):
            ...
            # Add diversity penalty to already used tokens
...
if __name__ == "__main__":
    expander = QFNNFieldExpanderStableV1()
